...
public class ConditionExample { // 기능 제공용 클래스
	...
	public void ex4() {
		...
		// 1, 2, 12 겨울 (-15 이하 : "한파 경보" / -12 이하 : "한파 주의보")
		// 3 ~ 5 봄
	...
	public void ex7() {
		...
		if(age < 12) {
			System.out.println("적정 연령이 아닙니다."); return;
		}
		...
		if(stature < 140) {
			System.out.println("적정 키가 아닙니다.");  return;
		}
	...
	public void ex8() {
		...
		if(age > 100 || age < 0) {
			System.out.println("나이를 잘못 입력하셨습니다."); return;
		}
		...
		if(height > 250 || height <= 0) {
			System.out.println("키를 잘못 입력하셨습니다."); return;
		}
		
		if(age >= 12 && height >= 140) {
			System.out.println("탑승 가능"); return;
		} else if(age < 12 || height < 140) {
			System.out.println("나이와 키 모두 적절치 않음"); return;
		}
			
			
			
		if(age < 12 || height >= 140) {
			System.out.println("키는 적절하나, 나이는 적절치 않음"); return;
