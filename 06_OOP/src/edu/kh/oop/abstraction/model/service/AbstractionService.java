...
public class AbstractionService {
	...
	public void ex1() {
		...
		*/
		...
		// 내 객체 만들기
		// People 클래스 이용하여 soomin
		
		People soomin = new People();
		...
		System.out.println(soomin.getGender());
		System.out.println(soomin.getpNo());
		System.out.println(soomin.getAddress());
		System.out.println(soomin.getPhone());
		System.out.println(soomin.getAge());
