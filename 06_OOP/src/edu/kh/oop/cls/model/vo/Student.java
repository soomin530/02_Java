...
//[접근제한자][예약어] class 클래스명
	...
	protected int v2 = 20; // 후손 클래스 내까지 접근 가능
	int v3 = 30; 		   // (default) 같은 패키지 내까지 접근 가능
	private int v4 = 40;   // 해당 클래스 내부까지 접근만 가능
	
	// final 예약어  
	private final int TEMP1 = 100; // final 키워드가 붙은 필드명은 대문자로 !!!!!
	...
	public void ex() {
		// 클래스 접근제한자 확인하기
		TestVO test = new TestVO(); // 같은 패키지에서만 접근 가능
