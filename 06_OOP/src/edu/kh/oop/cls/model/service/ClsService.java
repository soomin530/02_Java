...
public class ClsService /* extends Student */ { 
	...
	public void ex1() {
		...
		// (default) class 인 TestVO는 import 자체가 불가능 (다른 패키지라 불가)
		...
		// public - 프로그램 전체에서 접근 가능
		
		// System.out.println(v2);
		// Student 클래스를 상속받았으므로 Student 의 protected 변수인
		// v2는 직접 접근 가능 !!
		
		// System.out.println(v3);
		// (default) 다른 패키지라 접근 X
		
		// System.out.println(v4);
		// 해당 클래스가 아닌 다른 클래스라 접근 X
	...
	public void ex2() {
		...
		System.out.println( std1.schoolName );    //  빨간줄 - 에러  / 노란줄 - 경고
		System.out.println( std2.schoolName );
		// schoolName 에 노란줄이 뜨는 이유(경고) => 제대로 작성을 안 해서
	...
	public void ex3() {
		...
		// 해결방법 1: setter 를 이용해서 새로운 값 대입(덮어쓰기)
