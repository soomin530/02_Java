...
public class Run {
	public static void main(String[] args) {
		 ...
		 * 	  아래의 사용데이터를 참고하여 3명의 학생 객체 생성(초기화) 후
		 * 	  반복문을 통해 위의 학생 정보 모두 출력
		 * 
		 * 2. 최대 10명의 사원 정보를 기록할 수 있게 객체 배열을 할당하고
		 * 	  반복문(while(true))을 사용하여 키보드로 사원 정보를 계속 입력받도록 구현
		 * 	  계속 추가할 것인지 물어보고, 대소문자 상관없이 'y'면 계속 객체 추가
		 * 	  한 명씩 추가될 때마다 카운트함
		 * 	  2명 정도의 사원 정보를 입력 받아 각 객체 배열에 저장하고
		 * 	  현재까지 기록된 사원들의 정보 모두 출력
		 * 
		 * */
