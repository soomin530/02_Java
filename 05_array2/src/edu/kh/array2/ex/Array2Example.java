...
public class Array2Example {
	...
	public void ex1() {
		...
		arr[0][0] = 10;
		arr[0][1] = 20;
		arr[0][2] = 30; // 열 3칸이기 때문에 3번 인덱스는 없음
		...
		*/
		...
		System.out.println("Arrays.toString() : " + Arrays.toString(arr)); // [[I@7960847b, [I@6a6824be]
		
		// Arrays.deepToString(배열명)
		// : 참조하고 있는 배열의 실제 데이터가 나오는 부분까지 파고들어가서
		//   모든 값을 문자열로 반환
		System.out.println("Arrays.deepToString() : " + Arrays.deepToString(arr)); // [[10, 20, 30], [40, 50, 60]]
		
		// ** 2차원 이상부터는 deepToString !!!! **
	}
	...
	public void ex2() {
		...
		int[][] arr = { {1, 2, 3},
						{4, 5, 6},       // 3행 3열짜리 1 ~ 9까지 초기화한 값으로 넣어놓음
						{7, 8, 9} };		
