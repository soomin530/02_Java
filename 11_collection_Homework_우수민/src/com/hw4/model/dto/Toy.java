...
public class Toy {
	...
	public String getMaterialsAsString() {
		...
		for(String material: materials) {
			sb .append(material).append(", "); // append -> 문자열 뒤에 이어쓰기
		}
		// "고무, 면직물, " --> 위 과정으로 이렇게 변경 !
		// 만들어진 문자열의 마지막 쉼표와 공백 제거하기
		sb.setLength(sb.length() -2); // 문자열 마지막 쉼표 공백까지 2칸을 제거
		return sb.toString(); // StringBuilder 형태를 String 형태로 변환
	}
