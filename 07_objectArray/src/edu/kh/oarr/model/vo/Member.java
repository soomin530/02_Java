...
public class Member {
	...
	// getter / setter
	// -> 왜 만드나 ?
	// -> 필드에 선언된 멤버변수들이 캡슐화 원칙에 의해 private 으로 만들어짐.
	// -> private은 다른 클래스에서 직접 접근 불가함.
	// -> 간접 접근 방식으로 값을 세팅 / 얻어올 수 있어야 함.
	// -> 그래서 getter / setter 접근제한자가 어디서든 접근할 수 있도록 public 임.
	...
	// setter : 세팅하는 애, 무엇을 세팅할지 전달받아온 것이 매개변수(()안이 매개변수)
	public void setMemberId(String memberId) {
		// 반환형 void : 반환값이 없다 (그래서 자료형 없다) 
		this.memberId = memberId;
